...
export default function SearchField({currentLocation, setCityName , getWeather, getCityCoords, error}) {
  return (
    <div className="weather-box">  
      <div className = "searchfield-container">
        <form className="search-field"> 
          <input className="text-field" type="text" placeholder="City" onChange={e => setCityName(e.target.value)}/>
          <button type="submit" className="material-icons search-button" onClick={getCityCoords}>search</button>
        </form>
